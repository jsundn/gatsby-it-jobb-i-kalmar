...
const StyledTextOnlyHeader = styled('header')`
  text-align: center;
  color: rgb(1, 55, 96);
...
const Layout = ({
  ...
  <SiteWrapper flexDirection="column">
    ...
    {
      fullBleedCoverImage ?
      <FullBleedCoverImage fullBleedCoverImage={fullBleedCoverImage} text={siteMetadata.subheader} /> : (
        <StyledTextOnlyHeader>
          <HeaderText>{pageMetadata.description}</HeaderText>
        </StyledTextOnlyHeader>
      )
    }
